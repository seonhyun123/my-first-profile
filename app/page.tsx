...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100">
      ...
      <header className="pt-48 pb-32 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-slate-900">
            공간의 가치를 만드는<br />
            <span className="text-blue-700"> "부동산 디벨로퍼"로 성장하고 싶은 김성현</span>입니다.
          </h2>
          <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed break-keep">
            단국대학교 도시계획부동산학부 3학년 과정에 재학중이며.<br />
            이론을 넘어 현장을 보는 시각을 키우며, <br className="hidden md:block"/>
            실무에 강한 부동산 개발 전문가로 성장하고자 합니다.
          </p>
          ...
          <div className="w-full md:w-1/3">
             ...
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-4">
                <div>
                    ...
                    <p className="text-sm text-slate-600">도시계획부동산학부 
                     (주전공: 부동산학, 복수전공: 도시계획학)</p>
     ...
     <section id="projects" className="py-32 px-6 bg-white border-t border-slate-200">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* P1: 은마아파트 - 파일명: p1.png */}
            <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 transition group overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-4 line-clamp-3">
                  ...
                  임장을 통해 현장 상황을 파악하고 정비사업의 타당성을 검토했습니다.
                </p>
                <div className="flex gap-2 text-xs font-medium text-slate-500">
                  <span className="bg-white px-2 py-1 rounded border">재건축</span>
                  <span className="bg-white px-2 py-1 rounded border">시장분석</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 transition group overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 text-xs font-medium text-slate-500">
                  <span className="bg-white px-2 py-1 rounded border">지구단위계획</span>
                  <span className="bg-white px-2 py-1 rounded border">현장조사</span>
                </div>
              </div>
            </div>

            {/* P3: 연합 학술제 - 파일명: p3.png */}
            <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 transition group overflow-hidden">
              <div className="relative h-48 w-full bg-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-4 line-clamp-3">
                  건국대, 중앙대, 단국대 부동산학회 연합 학술제에 참여하여 
                  프로젝트 성과를 공유하고 타 대학 전공생들과의 네트워킹을 진행했습니다.
                </p>
                <div className="flex gap-2 text-xs font-medium text-slate-500">
                  <span className="bg-white px-2 py-1 rounded border">네트워킹</span>
                  <span className="bg-white px-2 py-1 rounded border">기획</span>
                </div>
              </div>
            </div>

            {/* P4: 한국투자부동산신탁 - 파일명: p4.png */}
            <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 transition group overflow-hidden">
              <div className="relative h-48 w-full bg-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-4 line-clamp-3">
                  ...
                  신탁사의 수익 구조와 리스크 관리 방식을 학습했습니다.
                </p>
                <div className="flex gap-2 text-xs font-medium text-slate-500">
                  <span className="bg-white px-2 py-1 rounded border">권리분석</span>
                  <span className="bg-white px-2 py-1 rounded border">토지신탁</span>
                </div>
              </div>
            </div>

            {/* P5: 가상토지 vs 현물토지 - 파일명: p5.png */}
            <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 transition group overflow-hidden">
              <div className="relative h-48 w-full bg-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-4 line-clamp-3">
                  ...
                  미래 부동산 시장의 변화와 토지 가치 평가의 새로운 관점을 연구했습니다.
                </p>
                <div className="flex gap-2 text-xs font-medium text-slate-500">
                  <span className="bg-white px-2 py-1 rounded border">메타버스</span>
                  <span className="bg-white px-2 py-1 rounded border">시장분석</span>
                </div>
              </div>
            </div>

            {/* P6: 조치원 도시재생 - 파일명: p6.png */}
            <div className="bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 transition group overflow-hidden">
              <div className="relative h-48 w-full bg-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-4 line-clamp-3">
                  ...
                  구도심과 신도심의 균형 발전을 위한 실질적인 아이디어를 도출했습니다.
                </p>
                <div className="flex gap-2 text-xs font-medium text-slate-500">
                  <span className="bg-white px-2 py-1 rounded border">도시재생</span>
                  <span className="bg-white px-2 py-1 rounded border">지역발전</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left max-w-2xl mx-auto bg-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-700">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-lg font-semibold text-white">경기도 용인시 수지구 죽전동</p>
                </div>
